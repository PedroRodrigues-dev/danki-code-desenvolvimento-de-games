		...
		if(!isDamaged) {
			if(dir == right_dir) {
				...
				if(arma) {
					...
					g.drawImage(Entity.GUN_RIGHT, this.getX() - Camera.x + 2, this.getY() - Camera.y + 3,null);
				}
			}else if(dir == left_dir){
				g.drawImage(leftPlayer[index], this.getX() - Camera.x, this.getY() - Camera.y, null);
				if(arma) {
					//Desenhar arma para a esquerda
					g.drawImage(Entity.GUN_LEFT, this.getX() - Camera.x - 2, this.getY() - Camera.y + 3,null);
				}
			}else if(dir == up_dir){
				g.drawImage(upPlayer[index], this.getX() - Camera.x, this.getY() - Camera.y, null);
				if(arma) {
					//Desenhar arma para cima
					g.drawImage(Entity.GUN_UP, this.getX() - Camera.x - 6, this.getY() - Camera.y + 4,null);
				}
			}else if(dir == down_dir){
				g.drawImage(downPlayer[index], this.getX() - Camera.x, this.getY() - Camera.y, null);
				if(arma) {
					//Desenhar arma para baixo
					g.drawImage(Entity.GUN_DOWN, this.getX() - Camera.x + 2, this.getY() - Camera.y + 3, null);
				}
			}
		} else {
